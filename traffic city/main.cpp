...
void car1() {
    glPushMatrix();
	glTranslatef(position_c1,0.0, 0.0f);
...
int main(int argc, char** argv) {
    ...
    cout << "Ajay M\t\t\t 1EW20CS004" << endl;
    cout << "Bhavana N \t\t 1EW20CS018" << endl;
